...
1. PyTorch에서 LBFGS 옵티마이저는 아직 stable하지 않아 쓰는 것이 권장되지 않는다.
	* [https://arxiv.org/pdf/2305.11930](https://arxiv.org/pdf/2305.11930)
	* 관련해서 참조한 discussion: [https://github.com/pytorch/pytorch/issues/5953](https://github.com/pytorch/pytorch/issues/5953)
